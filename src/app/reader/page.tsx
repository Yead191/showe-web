...
export default function ReaderIndexPage() {
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center bg-surface-base p-6 text-center">
      <h1 className="font-display font-bold text-2xl text-ink">No programme selected</h1>
      <p className="text-ink-muted mt-2">Open a programme from the library to start reading.</p>
