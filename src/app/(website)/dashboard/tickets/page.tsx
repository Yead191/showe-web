    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-1">
          ...
          <p className="text-gray-500 font-medium">
            Access your active bookings and entry codes
          </p>
        </div>
        <Button
          variant="outline"
          className="rounded-2xl h-11 px-6 border-gray-200 text-xs font-black uppercase tracking-widest gap-2 hover:bg-gray-50 transition-all"
        >
          <Calendar size={14} />
          Past Bookings
        </Button>
      ...
      <div className="grid grid-cols-1 gap-6">
        {MOCK_TICKETS.map((ticket) => (
          <div
            key={ticket.id}
            className="group relative bg-white border border-gray-100 rounded-[24px] md:rounded-[32px] overflow-hidden hover:shadow-2xl hover:shadow-black/5 transition-all duration-500"
          >
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex-1 p-6 md:p-8 space-y-4 md:space-y-6">
                <div className="flex items-center justify-between">
                  <Badge
                    className={`rounded-full px-3 md:px-4 py-0.5 md:py-1 text-[9px] md:text-[10px] font-black uppercase tracking-widest border-none ${
                ...
                <div className="pt-4 md:pt-6 border-t border-gray-50 flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-[9px] md:text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">
                      Your Seat
                    </p>
