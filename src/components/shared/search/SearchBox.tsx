...
export function SearchBox({ className, initialValues }: SearchBoxProps) {
  ...
  const [date, setDate] = useState<DateRange | undefined>(() =>
    parseInitialDate(initialValues?.date),
  );
  ...
  return (
    <div
      className={cn(
        "bg-white rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.08)] p-4 md:p-5 border border-gray-100",
        className,
      )}
    >
      <div className="flex flex-col lg:flex-row items-center gap-4 lg:divide-x divide-gray-100">
        ...
        <div className="flex-1 w-full flex items-center gap-4 px-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[10px] font-bold text-gray-900 uppercase tracking-wider mb-0.5">
              What
            </p>
            <input
              type="text"
        ...
        <div
          ref={whereRef}
          className="relative flex-1 w-full flex items-center gap-4 px-2 lg:pl-6 border-t lg:border-t-0 pt-4 lg:pt-0"
        >
          <div className="bg-gray-50 p-2 rounded-lg flex shrink-0">
            ...
            <PopoverTrigger asChild>
              <button className="w-full flex items-center gap-4 text-left outline-none group/when">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div
                    className={`text-sm ${date ? "text-gray-900" : "text-gray-400"} truncate`}
                  >
                    {date?.from
                      ? date.to
        ...
        <div className="w-full lg:w-auto lg:pl-6 border-t lg:border-t-0 pt-4 lg:pt-0">
          <Button
            ...
            className="w-full lg:w-40 h-12 bg-accent-400 hover:bg-[#e09900] text-white font-bold text-sm rounded-lg transition-all active:scale-[0.98]"
          >
            Search
          </Button>
        </div>
