    ...
    <div className="pt-8 mt-8 border-t border-slate-100 space-y-3">
      <div className="flex items-center justify-between gap-4">
        <Button
          ...
          className="text-slate-600 hover:text-primary-600 hover:bg-slate-100 -ml-3"
        >
        ...
        <Button
          ...
          className="h-12 px-8 bg-accent-400 hover:bg-[#e09900] text-white font-semibold rounded-xl
