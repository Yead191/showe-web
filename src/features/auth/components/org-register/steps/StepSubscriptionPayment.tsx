  ...
  return (
    ...
    >
      <div className="space-y-5">
        {/* Plan summary card */}
        <div className="p-6 rounded-2xl bg-linear-to-br from-primary-600 to-[#013138] text-white shadow-xl shadow-primary-600/20 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-48 h-48 bg-accent-400/15 rounded-full blur-3xl" />
          <div className="relative flex items-end justify-between">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-accent-400 mb-2">
                Selected plan
              </p>
        ...
        {!active ? (
          <>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed mb-4">
                    ...
                    will be taken today via Stripe Billing.
                  </p>
            ...
            <div className="flex items-start gap-3 text-xs text-slate-500">
              ...
              <p>
                Card details are securely processed by Stripe. SHOWE does not
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-emerald-700">
                  Your {tier.name} plan is live. Your monthly payment of £
                  {total.toFixed(2)} has been scheduled.
                </p>
              </div>
            </div>
          </div>
