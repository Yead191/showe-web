  ...
  return (
    ...
    >
      <div className="space-y-6">
        {/* Hero card */}
        <div className="relative overflow-hidden rounded-3xl p-8 bg-linear-to-br from-primary-600 via-[#015d65] to-[#013138] text-white">
          <div className="absolute -top-20 -right-20 w-64 h-64 bg-accent-400/20 rounded-full blur-3xl" />
          <div className="absolute -bottom-16 -left-16 w-48 h-48 bg-accent-400/10 rounded-full blur-3xl" />
          <div className="relative">
            <div className="w-14 h-14 rounded-2xl bg-accent-400 text-primary-600 flex items-center justify-center mb-4 shadow-lg">
              <PartyPopper size={26} />
            </div>
            <h3 className="text-2xl font-bold mb-1">You're set up.</h3>
            <p className="text-white/70 max-w-md">
              Head into the dashboard to build your first programme. We've sent
              a copy of your account details to{" "}
        ...
        <Button
          asChild
          className="w-full h-14 bg-accent-400 hover:bg-[#e09900] text-white text-lg font-bold rounded-xl shadow-lg hover:shadow-xl active:scale-[0.99]"
        >
          <a
            href="https://showe-dashboard.vercel.app/login"
            target="_blank"
...
function NextAction({
  ...
  return (
    <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
      <div className="w-9 h-9 rounded-lg bg-white shadow-sm flex items-center justify-center text-primary-600 mb-2">
        {icon}
      </div>
