      ...
      <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-4">
        {TIERS.map((t) => {
          ...
          return (
            ...
            >
              {t.recommended && (
                <span className="absolute -top-3 left-6 inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-primary-600 text-white">
