  ...
  return (
    <div className="min-h-screen lg:h-screen bg-slate-50 flex flex-col lg:flex-row overflow-x-hidden lg:overflow-hidden">
      ...
      <div className="w-full lg:w-2/5 xl:w-1/3 bg-primary-600 relative flex flex-col justify-between p-8 lg:p-12 text-white shrink-0 lg:h-screen lg:overflow-hidden">
        ...
        <div className="pointer-events-none absolute top-0 right-0 w-96 h-96 bg-accent-400/10 rounded-full blur-3xl -mr-20 -mt-20" />
        <div className="pointer-events-none absolute bottom-0 left-0 w-96 h-96 bg-accent-400/5 rounded-full blur-3xl -ml-20 -mb-20" />
        ...
        <div className="relative z-10">
          ...
          <div className="mt-12 lg:mt-16">
            ...
            />
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-accent-400/15 text-accent-400 text-xs font-bold uppercase tracking-wider mb-4 border border-accent-400/20">
              <Sparkles size={13} />
            ...
            <h1 className="text-3xl xl:text-4xl 2xl:text-5xl font-bold font-museo leading-tight mb-4 text-white">
              Empower Your <span className="text-accent-400">Organisation</span>{" "}
