    ...
    <form className="space-y-4" onSubmit={handleRegister} noValidate>
      <div className="space-y-2">
        ...
        <Input
          ...
          className={`h-11 border-gray-200 focus:border-accent-400 focus:ring-accent-400/20 ${errors.name ? "border-red-400 focus:border-red-400" : ""}`}
        />
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className={`h-11 border-gray-200 focus:border-accent-400 focus:ring-accent-400/20 ${errors.email ? "border-red-400 focus:border-red-400" : ""}`}
        />
      ...
      <div className="space-y-2">
        ...
        <PasswordInput
          ...
          className={`h-11 border-gray-200 focus:border-accent-400 focus:ring-accent-400/20 ${errors.password ? "border-red-400 focus:border-red-400" : ""}`}
        />
        {errors.password && (
      ...
      <div className="space-y-2 pb-2">
        ...
        <PasswordInput
          ...
          className={`h-11 border-gray-200 focus:border-accent-400 focus:ring-accent-400/20 ${errors.confirmPassword ? "border-red-400 focus:border-red-400" : ""}`}
        />
