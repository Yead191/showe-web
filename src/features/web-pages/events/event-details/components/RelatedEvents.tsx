  ...
  return (
    <section className="space-y-10 ">
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/events"
          className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-primary-600 hover:text-accent-400 transition-colors"
        >
          View All
          ...
          >
            <div className="relative aspect-4/3 rounded-3xl overflow-hidden shadow-sm border border-gray-100">
              ...
              <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-xl shadow-sm">
                <p className="text-xs font-black text-accent-400 tracking-tight">
                  ${rel.price.toFixed(0)}
                </p>
              </div>
            </div>
            <div className="space-y-2 px-1">
              ...
              <h3 className="text-sm font-black text-gray-900 leading-tight group-hover:text-accent-400 transition-colors line-clamp-2">
                {rel.title}
              </h3>
            </div>
          </Link>
