  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[calc(100%-2rem)] md:max-w-[700px] p-0 overflow-hidden border-none bg-white rounded-3xl shadow-2xl animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="bg-primary-600 p-6 md:p-8 text-white relative overflow-hidden">
            ...
            <div
              ...
              className={cn(
                ...
                selectedTier === tier.id
                  ? "border-[#014B52] bg-primary-600/5"
        ...
        <div className="p-5 md:p-6 bg-white border-t border-gray-100">
          ...
          <Button
            ...
            className="w-full h-12 md:h-14 bg-primary-600 hover:bg-[#023a40] text-white font-black text-xs md:text-sm rounded-xl transition-all flex items-center justify-center gap-2 group shadow-lg shadow-[#014B52]/10 disabled:opacity-50"
          >
            Proceed to Checkout
