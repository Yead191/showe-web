        ...
        <section className="space-y-10 ">
            <div className="flex items-center justify-between">
                <h2 className="text-3xl font-black text-gray-900 tracking-tight flex items-center gap-3">
                    <Beer className="h-8 w-8 text-accent-400" />
                    Nearby Bars
                </h2>
            </div>
                        ...
                        <>
                            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-sm border border-gray-100">
                                ...
                                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-xl shadow-sm flex items-center gap-1">
                                    ...
                                    <p className="text-xs font-black text-gray-900 tracking-tight">{bar.rating}</p>
                                </div>
                            </div>
                            <div className="space-y-2 px-1">
                                <div className="flex items-center justify-between">
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{bar.category}</p>
                                    <p className="text-[10px] font-black text-accent-400 uppercase tracking-widest">{bar.price}</p>
                                </div>
