      ...
      <DialogContent className="sm:max-w-100 border border-white/8 bg-[#07181d]/90 backdrop-blur-md text-white p-6 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.5),0_0_30px_rgba(239,68,68,0.05)] overflow-hidden">
        ...
        <DialogFooter className="flex flex-col sm:flex-row gap-2 mt-6 pt-4 border-t border-white/6 bg-transparent">
          <Button
            ...
            className="w-full sm:w-auto order-2 sm:order-1 bg-white/3 hover:bg-white/8 text-zinc-300 hover:text-white border border-white/5 transition-all duration-200"
          >
            Cancel
          </Button>
          <Button
            ...
            className="w-full sm:w-auto order-1 sm:order-2 bg-linear-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white font-medium shadow-[0_2px_10px_rgba(239,68,68,0.25)] hover:shadow-[0_2px_15px_rgba(239,68,68,0.35)] transition-all duration-200"
          >
