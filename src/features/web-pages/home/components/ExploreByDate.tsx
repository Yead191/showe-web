...
const DateCard = ({
  ...
  >
    <div className="space-y-1 relative z-10">
      <h3 className="text-accent-400 font-bold text-md md:text-lg">{title}</h3>
    ...
    <section className="container mx-auto px-4 py-10 lg:py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <DateCard
          ...
          onClick={() =>
            handleDateSelect(
              `${format(saturday, "yyyy-MM-dd")}_${format(sunday, "yyyy-MM-dd")}`,
            )
          }
        />
        <DateCard
          ...
          onClick={() =>
            handleDateSelect(
              `${format(weekStart, "yyyy-MM-dd")}_${format(weekEnd, "yyyy-MM-dd")}`,
            )
          }
        />
        <DateCard
          ...
          onClick={() =>
            handleDateSelect(
              `${format(monthStart, "yyyy-MM-dd")}_${format(monthEnd, "yyyy-MM-dd")}`,
            )
          }
        />
          ...
          <PopoverTrigger asChild>
            <div>
              <DateCard
                title="Custom"
                dateLabel={
                  selectedDate ? format(selectedDate, "d MMMM") : "Choose Date"
                }
                isCustom
              />
            </div>
