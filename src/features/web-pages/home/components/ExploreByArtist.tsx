      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-12">
          ...
          <div className="md:flex items-center gap-3 hidden ">
            <button className="swiper-button-prev-custom h-12 w-12 rounded-full border border-gray-200 flex items-center justify-center bg-white text-gray-600 hover:bg-accent-400 hover:border-accent-400 hover:text-white transition-all shadow-sm cursor-pointer active:scale-90">
              <ChevronLeft className="h-5 w-5" />
            </button>
            <button className="swiper-button-next-custom h-12 w-12 rounded-full border border-gray-200 flex items-center justify-center bg-white text-gray-600 hover:bg-accent-400 hover:border-accent-400 hover:text-white transition-all shadow-sm cursor-pointer active:scale-90">
            ...
            <SwiperSlide key={artist.id}>
              ...
              >
                ...
                <div className="space-y-1">
                  <h3 className="text-base font-black text-gray-900 group-hover:text-accent-400 transition-colors tracking-tight">
                    {artist.name}
                  </h3>
                </div>
              </Link>
