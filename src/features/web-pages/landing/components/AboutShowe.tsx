        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-xl text-slate-600 font-light leading-relaxed mb-10">
              Showe replaces traditional printed booklets with an interactive,
              digital experience. Everything you need to know about the
              performance is right in your pocket.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4 p-5 rounded-2xl bg-white shadow-sm border-l-4 border-accent-400">
                ...
                <div className="text-slate-600 pt-[2px]">
                  Just scan the QR code at the venue.{" "}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2 bg-primary-600 text-white p-8 md:p-10 rounded-[2rem] shadow-xl transition-all hover:translate-y-[-5px]">
              ...
              <p className="text-white/80 text-lg leading-relaxed">
                Point your camera, tap the link, and you're in. We believe
                technology should get out of the way so you can focus on the
                performance.
              </p>
            </div>
            {features.map((item, idx) => (
              <div
                key={idx}
                className={`p-8 rounded-[2rem] shadow-sm hover:shadow-xl transition-all hover:translate-y-[-5px] border border-slate-100 ${idx === 2 ? "md:col-span-2 bg-white" : "bg-white"}`}
              >
