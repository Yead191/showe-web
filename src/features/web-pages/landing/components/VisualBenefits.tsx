  ...
  const benefits = [
    {
      ...
      description:
        "No more juggling papers. Access schedules, interactive maps, cast bios, and exclusive director notes beautifully organized on your screen.",
    },
    {
      icon: MousePointerClick,
      title: "Interactive experience",
      description:
        "Click through performer profiles, discover hidden stories, and engage with the event in real-time as the performance unfolds.",
    },
    {
      icon: Bookmark,
      title: "Save and revisit anytime",
      description:
        "Build your personal event archive. Save your favorite programmes and relive the magic long after the curtain falls.",
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/2 space-y-12 order-2 lg:order-1">
            <div>
              ...
              <p className="text-xl text-slate-600 font-light leading-relaxed">
                Why settle for static text when you can explore the entire
                universe of the show? Experience events the modern way.
              </p>
            </div>
          ...
          <div className="lg:w-1/2 order-1 lg:order-2 w-full flex justify-center">
            <div className="relative w-full max-w-[400px]">
              ...
              <div className="relative aspect-9/19 bg-white rounded-[3rem] border-8 border-slate-900 shadow-2xl shadow-primary-600/20 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-primary-600">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 space-y-4">
                    ...
                    <h4 className="text-white font-museo text-2xl font-bold">
                      Romeo & Juliet
                    </h4>
                    <div className="flex gap-2">
                      <div className="px-3 py-1 bg-white/20 rounded-full text-white text-xs font-medium backdrop-blur-md">
                        Cast & Crew
                      </div>
                      <div className="px-3 py-1 bg-white/20 rounded-full text-white text-xs font-medium backdrop-blur-md">
                        Schedule
              ...
              <div
                className="absolute top-20 -right-8 bg-white p-4 rounded-2xl shadow-xl shadow-black/5 animate-bounce"
