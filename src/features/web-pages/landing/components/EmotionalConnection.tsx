        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative h-[600px] hidden md:block">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-3/5 w-[70%] h-[80%] rounded-[2rem] overflow-hidden border border-slate-200 shadow-2xl z-10 group">
              <div className="absolute inset-0 bg-primary-600/10 group-hover:bg-transparent transition-colors duration-700 z-10" />
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <p className="text-xl text-slate-600 font-light leading-relaxed">
                Every show, every concert, every match is a story. Showe lets
                you take that story home. Don't let the memories fade when the
                lights come up.
              </p>
            </div>
            ...
            <div className="space-y-8 pt-4">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Dive deep into the lives of the performers. Understand their
                    journey and feel a deeper connection to the art you love.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Loved a specific moment or a cast member's background? Save
                    your favorite profiles and share them with fellow fans
                    instantly.
                  </p>
                </div>
              </div>
