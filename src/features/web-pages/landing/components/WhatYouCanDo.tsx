...
export default function WhatYouCanDo() {
  const features = [
    {
      ...
      description:
        "Scan a QR code to access your programme instantly. No downloads, no waiting.",
    },
    {
      icon: <Search className="w-8 h-8 text-[#F2A900]" />,
      title: "Discover More",
      description:
        "Explore the cast, dive into rich stories, and uncover exclusive behind-the-scenes content.",
    },
    {
      icon: <Save className="w-8 h-8 text-[#F2A900]" />,
      title: "Interact & Revisit",
      description:
        "Interact with the event live, save your favorite moments, and revisit the programme anytime.",
    },
  ];
  ...
  return (
    <section className="py-24 bg-[#0C0C0C] relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-primary-600/10 rounded-full blur-[100px] -ml-48 -mb-48" />
          ...
          <div className="text-white space-y-12">
            <div>
              ...
              <p className="text-xl text-white/70 font-light">
                Elevate your event experience with interactive digital
                programmes that bring you closer to the action.
              </p>
            </div>
            ...
            <div className="absolute bottom-8 left-8 right-8 z-20">
              <div className="backdrop-blur-md bg-white/10 border border-white/20 p-6 rounded-2xl">
                <p className="text-white text-lg font-light italic">
                  "It felt like I was part of the show before it even started.
                  The digital programme is a game-changer."
                </p>
              </div>
            </div>
          </div>
