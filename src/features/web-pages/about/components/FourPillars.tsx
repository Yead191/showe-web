    ...
    <section className="py-10 lg:py-16">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-primary-600 font-museo mb-6">
            What Makes SHOWE Different
          </h2>
          <p className="text-gray-500 text-lg">
            We've built an all-in-one ecosystem designed to serve everyone—from
            fans and attendees to artists and event organizers.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div
              key={i}
              className="group p-8 rounded-[40px] border border-gray-100 hover:border-transparent hover:bg-gray-50 transition-all duration-300"
            >
              <div
              ...
              <h4 className="text-2xl font-bold text-primary-600 mb-4 tracking-tight">
                {pillar.title}
              </h4>
