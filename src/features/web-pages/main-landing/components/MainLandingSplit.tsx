        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="p-10 flex flex-col items-center text-center grow justify-center relative z-10">
              <div className="w-20 h-20 bg-primary-600/10 text-[#014B52] rounded-full flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
