      ...
      <div className=" container relative z-10 ">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-white space-y-8 order-2 lg:order-1">
            <h1
              className="text-[40px] md:text-4xl xl:text-5xl 2xl:text-6xl  font-bold font-museo leading-none animate-in slide-in-from-left-8 fade-in duration-1000 fill-mode-both"
            ...
            >
              Turn every event programme into a living, interactive experience.
              Instantly access it on your phone, explore rich content, discover
              the people behind the performance, and engage with the story as it
              unfolds, before, during, and after the event.
            </p>
          ...
          <div
            className="flex justify-center 2xl:justify-end order-1 lg:order-2 animate-in zoom-in-95 fade-in duration-1000 fill-mode-both"
            style={{ animationDelay: `${baseDelay + 300}ms` }}
          >
            <div className="relative h-full lg:h-[75vh] xl:h-[80vh]  rounded-[3rem]  shadow-[0_0_50px_rgba(245,168,0,0.15)] overflow-hidden bg-[#1C1C1C] p-1 border-4 border-[#1C1C1C]  ">
              {/* Notch/Camera Area */}
