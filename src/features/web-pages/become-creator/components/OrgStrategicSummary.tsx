        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            ...
            <p className="text-xl text-slate-600 font-light leading-relaxed mb-10">
              Stop wondering why engagement is low or costs are high. Showe
              provides a flexible, data-driven platform that solves the core
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4 p-4 rounded-xl bg-slate-50 border-l-4 border-accent-400">
                ...
                <div className="text-slate-600">
                  — Minutes. Not days. No coding required.
                </div>
              </div>
            </div>
          </div>
