        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              We've built Showe around the four pillars of successful event
              management.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {benefits.map((benefit, idx) => (
              <div
                key={idx}
                className="flex gap-6 p-8 bg-white rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow"
              >
                <div className="shrink-0 w-12 h-12 bg-primary-600/5 rounded-full flex items-center justify-center">
                  {benefit.icon}
                </div>
                <div>
