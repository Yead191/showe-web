    ...
    <section className="bg-white rounded-3xl p-6 md:p-8 border border-gray-100 shadow-sm space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-gray-50 hover:bg-primary-600 hover:text-white border border-gray-200 transition-all font-bold text-xs text-gray-800 shadow-xs shrink-0 self-start sm:self-auto cursor-pointer"
        >
