  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
      ...
      <div className="lg:col-span-2 space-y-8">
          ...
          <div className="prose prose-gray max-w-none">
            <p className="text-gray-600 text-base md:text-lg leading-relaxed whitespace-pre-line">
              {venue.description ||
                "Welcome to " +
                  venue.name +
                  ". Explore interactive event programmes, digital playbills, and upcoming live performances at this premier venue."}
            </p>
          </div>
        </div>
        ...
        {owner && (
          <div className="bg-linear-to-br from-primary-600 to-[#023338] text-white rounded-3xl p-6 md:p-8 shadow-xl shadow-[#014B52]/10 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-black uppercase tracking-widest text-accent-400">
              ...
              <div className="flex items-center gap-5">
                <div className="h-16 w-16 rounded-2xl bg-accent-400 flex items-center justify-center text-white text-xl font-black shrink-0 overflow-hidden relative shadow-lg shadow-black/20">
                  {owner.image ? (
                    <Image
        ...
        <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm space-y-6">
          ...
          <div className="space-y-4 text-sm text-gray-600">
            <div className="flex items-start gap-3">
              <div className="p-2.5 rounded-xl bg-gray-100 text-primary-600 shrink-0 mt-0.5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 leading-relaxed mt-0.5">
                  {[
                    ...
                    .filter(Boolean)
                    .join(", ") || "Location details upon booking."}
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-xs text-gray-600 hover:text-primary-600 mt-0.5 block"
                  >
                    {venue.contact_phone}
                  </a>
                </div>
