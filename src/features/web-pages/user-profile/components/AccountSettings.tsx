...
export function AccountSettings({ user }: { user: UserProfile }) {
  ...
  const displayImage =
    previewUrl || (user.image ? getImageUrl(user.image) : null);
      ...
      <div className="flex flex-col items-center gap-4 shrink-0">
        <div className="relative group">
          ...
          <button
            ...
            className="absolute bottom-0 right-0 p-2 bg-primary-600 text-white rounded-2xl shadow-lg hover:scale-110 active:scale-95 transition-all"
          >
            <Camera size={16} />
          </button>
          <input
