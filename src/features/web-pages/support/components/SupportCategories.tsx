      ...
      <div className="container   ">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {CATEGORIES.map((cat, i) => (
            <div
              key={i}
              className="group p-8 rounded-3xl border border-gray-100 hover:border-accent-400/20 hover:bg-gray-50 transition-all duration-300 cursor-pointer shadow-sm hover:shadow-xl"
            >
              <div
