        ...
        <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4 group">
                  <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-sm group-hover:bg-accent-400 group-hover:text-white transition-all duration-300">
                    <item.icon size={20} />
                  </div>
                  <div>
          ...
          <div className="lg:w-2/3">
            <div className="bg-white p-8 md:p-12 rounded-[40px] shadow-sm border border-gray-100 relative">
              {/* Decorative element */}
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-accent-400/10 rounded-full blur-2xl" />
