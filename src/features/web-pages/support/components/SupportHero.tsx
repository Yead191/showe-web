      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <h1 className="text-sm font-bold text-[#F5A800] uppercase tracking-[0.3em]">
              Help Center
            </h1>
          ...
          <div className="relative max-w-xl mx-auto group">
            <Search
              className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40 group-focus-within:text-[#F5A800] transition-colors"
              size={20}
            />
            <Input
              type="text"
          ...
          <div className="flex flex-wrap justify-center gap-4 text-white/60 text-sm font-medium">
            <span>Popular:</span>
            <button className="hover:text-[#F5A800] transition-colors">
              QR Scanning
            </button>
            <span>•</span>
            <button className="hover:text-[#F5A800] transition-colors">
