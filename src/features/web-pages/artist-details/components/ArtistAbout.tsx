...
import { Globe, Music, Mic2, Landmark } from "lucide-react"

export function ArtistAbout({ about }: { about: any }) {
    const details = [
        { label: "Origin", value: `${about.origin_city}, ${about.origin_country}`, icon: Landmark },
        { label: "Instruments", value: about.instruments.join(", "), icon: Mic2 },
        { label: "Career Start", value: about.career_start_year, icon: Music },
        { label: "Languages", value: about.languages.join(", "), icon: Globe },
    ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
                <div className="space-y-4">
                    ...
                    <div 
                        className="text-gray-500 text-lg leading-relaxed prose prose-gray max-w-none"
                        dangerouslySetInnerHTML={{ __html: about.bio_html }}
                    />
                </div>

                <div className="flex flex-wrap gap-3">
                    {about.genres.map((genre: string) => (
                        <span 
                            key={genre}
