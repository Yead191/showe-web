...
export const CATEGORIES: Category[] = [
  ...
  {
    name: "Ceremonies",
    backgroundImage: "/assets/bg/programmes/ceremonies.png",
  },
];
...
export const ALL_ITEMS: TheatreItem[] = [
  {
    ...
    author: "Kate Dylan",
    quote: "'Vivid and dangerous' SAMANTHA SHANNON",
    description:
      "Leadership & Development (L&D) is a strategic, ongoing process aimed at enhancing an individual's ability.",
    imageUrl: "/assets/images/books/book1.jpg",
  },
  {
    id: 1,
    title: "Until We Shatter 2",
    author: "Kate Dylan",
    quote: "'Vivid and dangerous' SAMANTHA SHANNON",
    description:
      "A powerful story of resilience and determination that will leave you breathless.",
    imageUrl: "/assets/images/books/book1.jpg",
  },
  {
    id: 2,
    title: "Until We Shatter 3",
    author: "Kate Dylan",
    quote: "'Vivid and dangerous' SAMANTHA SHANNON",
    description:
      "An epic journey through worlds unknown, charting new territories of the imagination.",
    imageUrl: "/assets/images/books/book1.jpg",
  },
  {
    id: 3,
    title: "Until We Shatter 4",
    author: "Kate Dylan",
    quote: "'Vivid and dangerous' SAMANTHA SHANNON",
    description:
      "A gripping tale of adventure, love, and survival against impossible odds.",
    imageUrl: "/assets/images/books/book1.jpg",
  },
  {
    id: 4,
    title: "Until We Shatter 5",
    author: "Kate Dylan",
    quote: "'Vivid and dangerous' SAMANTHA SHANNON",
    description:
      "The most anticipated continuation of the series fans have been waiting for.",
    imageUrl: "/assets/images/books/book1.jpg",
  },
  {
    id: 5,
    title: "Until We Shatter 6",
    author: "Kate Dylan",
    quote: "'Vivid and dangerous' SAMANTHA SHANNON",
    description:
      "A heartfelt narrative of sacrifice and courage in the face of overwhelming darkness.",
    imageUrl: "/assets/images/books/book1.jpg",
  },
  {
    id: 6,
    title: "Until We Shatter 7",
    author: "Kate Dylan",
    quote: "'Vivid and dangerous' SAMANTHA SHANNON",
    description:
      "An unforgettable experience that redefines what fantasy storytelling can achieve.",
    imageUrl: "/assets/images/books/book1.jpg",
  },
  {
    id: 7,
    title: "Until We Shatter 8",
    author: "Kate Dylan",
    quote: "'Vivid and dangerous' SAMANTHA SHANNON",
    description:
      "Brilliant storytelling with characters that live beyond the final page.",
    imageUrl: "/assets/images/books/book1.jpg",
  },
  {
    id: 8,
    title: "Until We Shatter 9",
    author: "Kate Dylan",
    quote: "'Vivid and dangerous' SAMANTHA SHANNON",
    description:
      "A tour de force of imagination that cements Kate Dylan's place as a master storyteller.",
    imageUrl: "/assets/images/books/book1.jpg",
  },
  {
    id: 9,
    title: "Until We Shatter 10",
    author: "Kate Dylan",
    quote: "'Vivid and dangerous' SAMANTHA SHANNON",
    description:
      "The final chapter of an era — epic, emotional, and utterly unforgettable.",
    imageUrl: "/assets/images/books/book1.jpg",
  },
];
// ─────────────────────────────────────────────────────────────────────────────
...
export function useTheatreStore() {
  ...
  return {
    ...
    currentBackground:
      CATEGORIES[selectedCategoryIndex]?.backgroundImage ??
